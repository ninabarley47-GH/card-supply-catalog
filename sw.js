...
const APP_SHELL = [
  ...
  "./js/card-images.js",
  "./js/cards.js",
  "./js/detail-navigation.js",
  "./js/color-form.js",
  "./js/cover-sheet.js",
  "./js/cover-sheet-folder.js",
  "./js/global-tag-filter.js",
  "./js/global-tag-catalog.js",
  "./js/global-tag-management.js",
  "./js/global-tag-persistence.js",
  "./js/images.js",
  "./js/import-mode.js",
  "./js/library.js",
  "./js/owners.js",
  ...
  "./js/stamp-die-filter.js",
  "./js/search.js",
  "./js/owner-picker.js",
  "./js/stamp-die-library.js",
  "./js/image-references.js",
  "./js/stamp-die-images.js",
  "./js/stamp-die-image-tags.js",
  "./js/ui.js",
  "./js/tag-picker.js",
  "./js/tag-utils.js",
  "./js/thumbnails.js",
